var em = [
  ...
  window.onload = function () {
    $("#ol").html(
      `<center>
      <div id="inst">
        <h3 class="game-title">Match The Cards !</h3>
        ...
        <p style="font-size: 25px; font-weight: 400; margin-top: 90px">
          Click one of the following mode to start the game.
        </p>
        <button class="btn btn-outline-light btn-lg modes" onclick="start(3, 4)">
          3 x 4
        </button>
        <button
          class="btn btn-outline-light btn-lg modes"
          onclick="start(4, 4)"
          style="w"
        >
          4 x 4</button
        ><button class="btn btn-outline-light btn-lg modes" onclick="start(4, 5)">
          4 x 5</button
        ><button class="btn btn-outline-light btn-lg modes" onclick="start(5, 6)">
          5 x 6</button
        ><button class="btn btn-outline-light btn-lg modes" onclick="start(6, 6)">
          6 x 6
        </button>
      </div>
    </center>`
      ...
      if (rem == 0) {
        ...
        setTimeout(function () {
          ...
          <div id="iol">
            ...
            <button class="btn btn-outline-light btn-lg modes2" onclick="start(3, 4)">
              3 x 4
            </button>
            <button
              class="btn btn-outline-light btn-lg modes2"
              onclick="start(4, 4)"
              style="w"
            >
              4 x 4</button
            ><button class="btn btn-outline-light btn-lg modes2" onclick="start(4, 5)">
              4 x 5</button
            ><button class="btn btn-outline-light btn-lg modes2" onclick="start(5, 6)">
              5 x 6</button
            ><button class="btn btn-outline-light btn-lg modes2" onclick="start(6, 6)">
              6 x 6
            </button>
          </div>
        </center>`);
